...
function addOption(){
    ...
    optionContainer[0] = document.getElementById("sched_directives")
...
// Send request to the back-end using AJAX. The configuration of ECharts only apply to the chunksize version.
function data_visualisation(){
    var allRows = []
    var tb = document.getElementById("optionsTable");    //Get table object
    var rows = tb.rows;
    for(var i=1;i<rows.length;i++){    //Loop through all rows
        var eachRow = []
        var cells = rows[i].cells;
        for(var j=0;j<cells.length-1;j++){   //Loop through all columns
                    ...
                    var option = {
                        ...
                        tooltip: {
                            ...
                            formatter: function(params){
                                var res = '  Chunksize: '+params[0].value[0]
